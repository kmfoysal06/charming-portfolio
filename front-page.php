...
<div class="charming_portfolio-plugin-inner">
    ...
    **/
    ...
    <?php endif; ?>
    <?php if($portfolio_saved_value['layout'] === 'charming_v3'):?>
        <!-- Charming V2 Layout -->
        <?php CHARMING_PORTFOLIO_get_template_part("template-parts/frontpage/charming_v3/index", "", $portfolio_saved_value);?>
    <?php endif; ?>
