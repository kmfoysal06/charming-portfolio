...
<div class="charming-portfolio-container charming-portfolio-hero-section">
    <div class="hero-text hero__inner">
        ...
        <p class="short-description"><?php 
            $charming_portfolio_description = (is_array($args) && isset($args['description'])) ? $args['description'] : 'hello';
            echo wp_kses(CHARMING_PORTFOLIO_special_tag($charming_portfolio_description), array(
                'b' => [],
                'br' => [],
            ));
        ?></p>
