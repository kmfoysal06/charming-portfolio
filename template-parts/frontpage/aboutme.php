...
?>
 <div class="flex flex-col" tabindex="0">
  <div class="aboutme-title my-3 flex flex-col items-center">
    <div class="badge badge-neutral"><?php _e("About Me","simplecharm-portfolio-plugin"); ?></div>
    <h3 class="text-xl"><?php _e("Curious about me? Here you have it:","simplecharm-portfolio-plugin"); ?></h3>
  </div>
