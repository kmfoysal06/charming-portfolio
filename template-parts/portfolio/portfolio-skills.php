...
<div class="portfolio-section-wrapper">
	<h3 class="portfolio-section-toggle"><?php _e("Skills Customization","simplecharm-portfolio-plugin"); ?></h3>
...
<p><a id="simplecharm_skill_link_add" class="button" href="#"><?php _e("Add Another","simplecharm-portfolio-plugin"); ?></a></p>
</div>
</div>