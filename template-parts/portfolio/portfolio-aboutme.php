...
<div class="portfolio-section portfolio-aboutme portfolio-section-content">
	...
	<textarea id="description" class="description quill-textarea-slot" name="CHARMING_PORTFOLIO[description]" maxlength="800" rows="4"><?php echo esc_textarea(isset($args["description"]) ? $args["description"] : '') ?></textarea>
