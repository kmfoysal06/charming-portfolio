...
<div class="portfolio-section-wrapper">
    ...
    <div class="portfolio-section portfolio-section-content">
    	<div class="flex justify-between">
            ...
            <input id="primary-statbox-content" class="primary-statbox-content" type="text" name="CHARMING_PORTFOLIO[primary-statbox-content]" maxlength="6" placeholder="<?php echo esc_attr_e("eg: 2+, 200+ etc", "charming-portfolio"); ?>" value="<?php echo esc_attr(isset($args["primary_statbox_content"]) ? $args["primary_statbox_content"] : '') ?>">
        </div>
    	<div class="flex justify-between">
            ...
            <input id="primary-statbox-label" class="primary-statbox-label" type="text" name="CHARMING_PORTFOLIO[primary-statbox-label]" maxlength="20" placeholder="<?php echo esc_html_e("eg: Years Exp, Project Completed etc.", "charming-portfolio"); ?>" value="<?php echo esc_attr(isset($args["primary_statbox_label"]) ? $args["primary_statbox_label"] : '') ?>">
        </div>
