...
if (is_array($args) && array_key_exists("footer_links", $args)):
            ...
            ?>
              <tr class="footer_links flex">
                <td>
                  <label for="<?php echo esc_attr("footer_link_name_" . $key); ?>" class='screen-reader-text'></label>
                ...
                <td>
                  <label for="<?php echo esc_attr("footer_link_url_" . $key); ?>" class='screen-reader-text'></label>
    ...
    <tr class="charming_portfolio_empty-row__footer_link screen-reader-text footer_links flex">
           <td>
            <label for="footer_link_name" class='screen-reader-text'></label>
            <input type="text" class="name" data-queue="0" placeholder="footer link name" value="" id="footer_link_name" /></td>
          <td>
            <label for="footer_link_url" class='screen-reader-text'></label>
