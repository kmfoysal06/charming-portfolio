...
if (is_array($args) && array_key_exists("experiences", $args)):
 ...
 <tr class="flex flex-col simplecharm-basic-border simplecharm-basic-padding">
    <td>
        <label for="<?php echo esc_attr("experience-institution-" . $key,'charming-portfolio'); ?>"><?php _e("Institution",'charming-portfolio'); ?></label>
    ...
    <td>
        <label for="<?php echo esc_attr("experience-post-title-" . $key); ?>" title="<?php _e("enter your job post title eg:- Sr. Laravel Developer etc.","charming-portfolio"); ?>"><?php _e("Post Title","charming-portfolio"); ?></label>
        <input type="text" class="post-title" placeholder="<?php _e('Post Title','charming-portfolio'); ?>" name="CHARMING_PORTFOLIO[experiences][<?php echo esc_attr($key); ?>][][post-title]" value="<?php echo (array_key_exists("post-title",$flattern_experience)) ? esc_attr($flattern_experience['post-title']) : '' ;?>" id="<?php echo esc_attr("experience-post-title-" . $key,'charming-portfolio'); ?>" data-queue="<?php echo esc_attr($key); ?>">
    </td>
    <td class="responsibilities" id="repeatable-fieldset-three">
        <label for="<?php echo esc_attr("responsibilities-" . $key); ?>" title="<?php _e('enter list separated by three dash (---) eg:- ---first responsibility --- second responsibility ---third responsibility etc.','charming-portfolio'); ?>"><?php _e('Responsibilities','charming-portfolio'); ?></label>
    ...
    <td>
        <label for="<?php echo esc_attr("start-date-" . $key); ?>"><?php _e("Start Date",'charming-portfolio'); ?></label>
        <input type="date" class="start_date" name="CHARMING_PORTFOLIO[experiences][<?php echo esc_attr($key); ?>][][start_date]" placeholder="<?php _e("Start Date",'charming-portfolio'); ?>" id="<?php echo esc_attr("start-date-" . $key); ?>" data-queue="<?php echo esc_attr($key); ?>" value="<?php echo (array_key_exists("start_date",$flattern_experience)) ? esc_attr($flattern_experience['start_date']) : '' ;?>">
    </td>
    <td>
        <label for="<?php echo esc_attr("end-date-" . $key); ?>"><?php _e("End Date",'charming-portfolio'); ?></label>
        <input type="date" class="end_date" name="CHARMING_PORTFOLIO[experiences][<?php echo esc_attr($key); ?>][][end_date]" placeholder="<?php _e("End Date",'charming-portfolio'); ?>" id="<?php echo esc_attr("end-date-" . $key); ?>" data-queue="<?php echo esc_attr($key); ?>" value="<?php echo (array_key_exists("end_date",$flattern_experience)) ? esc_attr($flattern_experience['end_date']) : '' ;?>" <?php disabled($working_now,'on');?>>
    </td>
    <td>
        <label for="<?php echo esc_attr("working-now-" . $key,'charming-portfolio'); ?>" title="<?php _e("Are You Still Working Here?",'charming-portfolio'); ?>"><?php _e("Still Working?",'charming-portfolio'); ?></label>
